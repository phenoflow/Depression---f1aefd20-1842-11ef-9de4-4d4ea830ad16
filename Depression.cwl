...
steps:
  ...
  depression-dysthymia---primary:
    run: depression-dysthymia---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  other-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-dysthymia---primary/output
  ...
  depression-prolonged---primary:
    run: depression-prolonged---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-agitated---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-prolonged---primary/output
